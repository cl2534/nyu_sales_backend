...
salepost2 = SalePost.create(name: 'Jean for sale', picture_url: 'https://forthemommas.com/wp-content/uploads/2014/02/jeans1.jpg',  user_id: 1, price: '$25')
salepost3 = SalePost.create(name: 'Bomber jacket for sale', picture_url: 'https://www.legendaryusa.com/thumbnail.asp?file=assets/images/Z21P007A.jpg&maxx=600&maxy=0',  user_id: 1, price: '$50')
#
# # Books
salepost4 = SalePost.create(name: 'Econometrics Textbook for sale', picture_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNyYjLMT7n9ZCXR-tEGkn5tync_WQ98xGRj24L164xJwQGA53f',  user_id: 1, price: '$60')
...
salepost6 = SalePost.create(name: 'Couch for sale', picture_url: 'https://www.furniturerow.com/fr/images/products/SS-PKRNCH.JPG',  user_id: 1, price: '$100')
...
#
# #Pet Supplies
salepost8= SalePost.create(name: 'Dog Food for sale', picture_url: 'https://media.tractorsupply.com/is/image/TractorSupplyCompany/5138515?$470$',  user_id: 5, price: '$30')
...
salepost17= SalePost.create(name: 'Bang & Olufsen for sale', picture_url: 'https://www.bhphotovideo.com/images/images2500x2500/b_o_play_by_bang_olufsen_1280346_beolit_17_bluetooth_speaker_1320901.jpg',  user_id: 5, price: '$400')
#
# #PostCategory
# #Clothing posts
...
comment1 = Comment.create(comment: "I am interested", sale_post_id: 2, user_id: 1)
